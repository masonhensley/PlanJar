...
class Load_plans extends CI_Model
{
    ...
    function loadPlanData($plan)
    {
        ...
        $htmlString = "
        <div style=\"font-size:20px; widht:100%; height:90%; color:darkblue; text-align: center;\">
        $category at $name | $time_of_day | $date
        </div><br/><br/>
        <div style=\"width:100%; font-size: 20px; height:10%; text-align:left;\"><div class=\"delete_plan\" style=\"fload:right; width:100px; height:100%;\">Delete Plan</div></div>";
