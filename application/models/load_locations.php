        ...
        if (count($place_id_array) > 0)
        {
            ...
            foreach ($place_id_array as $place_id => $count)
            {
                ...
                <div class="location_tab" place_id="<?php echo $place_id; ?>">
                    <div class="number" style="background-color: white; color: black;position:absolute; top:0px; left:0px; height:10px;width:10px;border-right:1px solid gray; border-bottom:1px solid gray;">
