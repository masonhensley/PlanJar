...
class Display_group_template extends CI_Model
{
    ...
    function get_group_template($format_type, $selected_groups, $day, $data_array)
    {
        ...
        <div class="group_graph_top_left" >
            ...
            {
                ?>
                <div id="view_group_list" style="color:navy; position:absolute; top:23px; left:0px">See Members</div>
                <?php
            } else if ($format_type == 'friends')
            {
                ?>
                <a href="/dashboard/friends/" id="friends_link"><div style="color:navy; position:absolute; top:23px; left:0px">See Friends</div></a>
                <?php
            } else if ($format_type == 'school')
            {
                ?> 
                <a href="/dashboard/groups/" id="groups_link"><div style="color:navy; position:absolute; top:23px; left:0px">See School</div></a>
                <?php
            }
            ?>
