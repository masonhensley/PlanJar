...
class Load_location_data extends CI_Model
{
    ...
    function get_place_html($place_info, $place_data_array, $sql_date, $big_day_display)
    {
        ...
        <div style="width:12px; height:12px; background-color:pink; position:absolute; "></div>
        <div style="font-weight:bold; font-size: 12px;position:absolute;  "><font style="font-size:11px;">
            <?php echo $place_data_array['percent_female'] . "% "; ?></font>female</div>

        <div style="width:12px; height:12px; background-color:lightblue; position:absolute; "></div>
        <div style="font-weight:bold;font-size: 12px; position:absolute; "><font style="font-size:11px;">
