...
// start output buffering
        ...
        <div style="position:absolute; color:gray;top:48px;right:124px;"># plans made here by day</div>
        ...
        <div class="make_plan" style="background:white; color:gray;">Make a plan here</div>
