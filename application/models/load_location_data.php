...
class Load_location_data extends CI_Model
{
    ...
    function get_place_html($place_info, $place_data_array, $sql_date)
    {
        ...
        <div style="font-weight:bold;font-size: 12px; position:absolute; top:96px; left:69px;"><font style="font-size:10px;"><?php echo $place_data_array['percent_male'] ."% "; ?></font>male</div>
        <div style="font-weight:bold; font-size: 12px;position:absolute; left:150px; top:97px;"><font style="font-size:10px;"><?php echo $place_data_array['percent_female'] ."% "; ?></font>female</div>
