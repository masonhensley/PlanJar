...
// start output buffering
        ...
        <div class="display_date">
            <div style="font-size:100px; color: #7BC848; line-height:75px;overflow:hidden; display:inline-block;"><?php echo $place_data_array['big_day']; ?></div>
            <div style="font-size:100px; color:darkgray; line-height: 75px;overflow:hidden; display:inline-block;"><?php echo $place_data_array['big_day_date']; ?></div>
        </div>
