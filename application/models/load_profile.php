...
class Load_profile extends CI_Model
{
    ...
    function display_profile($user, $format)
    {
        ...
        } else
        {
                ...
                {
                    ?>
                    <textarea id="box_text_area" name="comments" cols="30" rows="5" maxlength="80"onclick="function(){$('textarea#box_text_area').text('')};">You have 80 characters to work with</textarea>
                    <div class="edit_box">
                        edit box
                    </div>
