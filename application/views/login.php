            ...
            <div id="leftSide">
                ...
                <fieldset>
                    ...
                    <form id="sign_up">
                        ...
                        <div class="div_texbox">
                            <input id="su_email_1" name="su_email_1" type="text" class="textbox" value="you@domain.com">
                        </div>
                        ...
                        <div class="button_div">
                            <input onclick="alert('submit'); $('sign_up').submit()" class="buttons" type="button" value="Sign up">
                        </div>
                    </form>
                </fieldset>
            </div>
