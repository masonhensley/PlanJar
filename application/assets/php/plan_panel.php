<div id="plan_content">
    ...
    <form id="make_plan">
        ...
        <div class="in-field_block">
            <p>Start typing the name of where you want to go.
                If we don't find your location, don't worry about it.</p>
        ...
        <div class="in-field_block">
            <p>Start typing what you plan on doing. Choose an option from the menu.</p>
